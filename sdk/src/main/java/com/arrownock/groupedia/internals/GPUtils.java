...
public class GPUtils {
    ...
    private final static String GS_BASE_URL = Constants.GS_HOST;
    ...
    public static String sendRequest(Context context, String path, String method, boolean secureConnection,
        ...
        try {
            ...
            if (secureConnection) {
                URL url = new URL(Constants.HTTPS + getGSHost(context) + "/" + reqPath);
                ...
                URL url = new URL(Constants.HTTP + getGSHost(context) + "/" + reqPath);
    ...
    private static String getGSHost(Context context) {
        String api = getFromLocalStorage(context, PREF_GS_API);
        return "".equals(api) ? GS_BASE_URL : api;
    }
